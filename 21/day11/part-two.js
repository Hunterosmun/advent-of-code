...
function main (list, steps) {
  ...
  for (let inf = 0; inf > -1; inf++) {
    if (ninesLength >= 100) break
    numOfSteps += 1
    ninesLength = 0
    // this should be where I go over the steps
...
assert.strictEqual(main(example), 195)
assert.strictEqual(main(santasList), 279)
